export const oneFree = ({ name }) => {
  return `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="EN">
<head>
<!--[if gte mso 15]>
<xml>
		...
		<center style="width: 100%; background-color: #f1f1f1;">
										...
										<div class="text"
											...
											<table class="hero-table desktop"
												...
												<tr>
													...
													<td>
														<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/xft1jduvrxyx8r7mhxi2.png">
													</td>
												...
												<tbody>
													<tr>
														<td>
															...
															<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/kxxghaopzc9lw3dtvowr.png">
															<p class="schore-text"
																style="    margin-left: 50px; font-size: 16px; line-height: 24px; color: black; padding:0px;">
			...
			<div style="background-color: #024F4A; color: white;text-align: center;">
				<div style="display: inline-block;" class="responsive-width">
					...
					<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208414/Glo-Raise/xyagfxk4hzkz8vs7qkpa.png" style="width: 100%;" />
			...
			<div style="background-color: #C2DEEC; color: black; display: inline-table; padding: 50px 0px;">
				<div class="responsive-width">
					...
					<div class="section_box">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208443/Glo-Raise/weirgwhnyrdrvtkwwmnp.png" />
					</div>
				</div>
			...
			<div style="background-color: #E5DFFA; color: black; display: inline-table; padding: 50px 0px;">
				<div style="width: 85%;">
					<div class="section_box">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208443/Glo-Raise/rot2ydjssugavnm6lk90.png" />
					</div>
			...
			<div style="background-color: #F4D4D5; color: black; display: inline-table; padding: 50px 0px;">
				<div style="width: 85%;">
					...
					<div class="section_box">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208444/Glo-Raise/gaughkscoxpcpobj8uuu.png" />
					</div>
			...
			<div style="background-color: #E5DFFA; color: black; display: inline-table; padding: 50px 0px;">
				<div style="width: 85%;">
					<div class="section_box">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208444/Glo-Raise/im6w8gmxs7ryv487pcm5.png" />
					</div>
					<div style="color: #2E2873; padding-left: 10px;" class="section_box">
						<p class="heading" style="font-size: 38px; line-height: 48px; font-weight: 600;">
							Level 1 — Canva </p>
			...
			<div style="background-color: #F8F8F8; color: white; display: inline-table; padding: 50px 0px;">
				<div class="responsive-width-85">
					<div class="arrow-down-image" style="width: 18%; display: inline-block; float: left;">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208444/Glo-Raise/bqg4funpcjetxoqasipe.png" />
					</div>
					...
					<div class="sun-question" style="width: 18%; display: inline-block; float: right;">
						<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208444/Glo-Raise/vmmogm6eozujrs2jr1c7.png" />
					</div>
			...
			<div style="background-color: #051C09; color: white; display: inline-table; padding: 50px 0px;">
				<div class="responsive-width-imp-business">
					...
					<div style="background-color: #CAFF87; color: black;" class="tab-box">
						...
						<div style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208445/Glo-Raise/k1yli7upgcruzigc3yot.png" /></div>
					</div>
					...
					<div style="background-color: #E5DFFA; color: black;" class="tab-box">
						...
						<div style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208445/Glo-Raise/jkgeaw4ufyjycgsiuyxi.png" /></div>
					</div>
					...
					<div style="background-color: #C2DEEC; color: black;" class="tab-box">
						...
						<div style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208445/Glo-Raise/gjy7ycxnz2qyhyuqcysj.png" /></div>
					</div>
					...
					<div style="background-color: #FFFFFF; color: black;" class="tab-box">
						...
						<div style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208445/Glo-Raise/ymrxmk3um3s0ljci31y6.png" /></div>
					</div>
					...
					<div style="background-color: #F4D4D5; color: black;" class="tab-box">
						...
						<div class="img-right-top" style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208443/Glo-Raise/jvh9gkpj85jn4eqqkkq8.png" />
						</div>
					</div>
					...
					<div style="background-color: #EBE6DC; color: black;" class="tab-box">
						...
						<div class="img-right-top" style="vertical-align: bottom;"><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208443/Glo-Raise/xtr9dibcdyeiinq1sbgb.png" />
						</div>
					</div>
				...
				<div>
					<div class="tab-box desktop">
						<div style="vertical-align: bottom; width: 8%; margin-left: -100px;">
							<img class="img-width-114" src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208442/Glo-Raise/fknp2h2i8v1isy2bztam.png">
						</div>
						...
						<div style="vertical-align: top; width: 10%; margin-left: -100px;">
							<img class="img-width-124" src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208443/Glo-Raise/gifa3029lxemev1pfurr.png" />
						</div>
					</div>
			...
			<div style="background-color: #2E2873; color: white; margin-top: -20px;     padding: 50px 0px;">
				<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/vunwhi5i1zlmyotoybt5.png" />
				...
				<div class="social-icons">
					<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/rb3hpt6ksjbyyn5bhh7i.png" />
					<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/f6d96pyb3akqimhwddgn.png" />
					<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/va09ymn4gljkheqhh39j.png" />
					<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/jqtcncef3jm9xv627daa.png" />
				</div>
			</div>
			<div style="background-color: #051C09;     padding: 50px 0px;">
				<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208445/Glo-Raise/pb1sywilwxwnrsqjidjh.png" style="width: 160px; height: 30px; margin: 3%;" />
								...
								<tbody>
									<tr onclick="topFunction()" id="myBtn">
										<td style="    font-size: 20px; line-height: 28px; font-weight: 400;">
											Back to top</td>
										<td><img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/sqjz4mgt2breajmrwmsw.png" /></td>
									</tr>
								</tbody>
							</table>
						</div>
	...
	<body width="100%"
		...
		<center style="width: 100%; background-color: #f1f1f1;">
										...
										<div class="text"
											...
											<table class="hero-table desktop"
												...
												<tr>
													...
													<td>
														<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/gr7jw5kqx4nla8hhfmub.png">
													</td>
											...
											<table style="display: none" class="hero-table mobile">
												<tbody>
													<tr>
														<td>
															<h3 class="score-heading">Your score is</h3>
															<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/m0dmdsrujfzazaw3wtkv.png">
															<p class="schore-text"
																style="    margin-left: 50px; font-size: 16px; line-height: 24px; color: black; padding:0px;">
																Scores range from Level 1 (lowest) to Level 5 (highest)
																with
			...
			<img class="desktop" style="position: absolute; z-index: -1;	margin-top: -379px;	left: -30px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/j5e3ujqaqjaiawvviamh.png" />
			<img class="mobile" style="position: absolute; z-index: -1;	width: 100%;margin-top: -100px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/fgoltsir3fddxgsgvilz.png" />
			</td>
			</tr><!-- end tr -->
			</table>
			</div>
								...
								<tr>
									<td class="blur email-section" style="text-align:center;">
										...
										<div class="img-text-box">
											<div>
												<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208481/Glo-Raise/puthwgqaqamt7nfiy0oq.png" alt=""
										...
										<div class="img-text-box">
											<div>
												<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208481/Glo-Raise/gdbeij9e7o8qxybwc4kn.png" alt=""
													style="width: 100%; max-width: 110px; height: auto; margin: auto; margin-bottom: 20px; display: block;">
											</div>
											<div class="text-testimony heading-section-white"
												style="text-align: center;">
										...
										<div class="img-text-box">
											<div>
												<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208481/Glo-Raise/rld2rlq7oatvz41elabl.png" alt=""
													style="width: 100%; max-width: 110px; height: auto; margin: auto; margin-bottom: 20px; display: block;">
											</div>
											<div class="text-testimony heading-section-white"
												style="text-align: center;">
										...
										<div class="img-text-box">
											<div>
												<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208481/Glo-Raise/jkvez4vyzzgfwj7haxgr.png" alt=""
													style="width: 100%; max-width: 110px; height: auto; margin: auto; margin-bottom: 20px; display: block;">
											</div>
											<div class="text-testimony heading-section-white"
												style="text-align: center;">
  ...
  return `<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
	...
	<body width="100%"
		...
		<center style="width: 100%; background-color: #f1f1f1;">
			...
			<div>
				<img class="desktop" style="width: 100%;"  src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/zy3nvcidhkef23tqmdt4.png"/>
				<img class="mobile" style="width: 100%;" src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/aryfxzcqlfjyp3pxcwmn.png"/>
			</div>
			<div style="background-color: #2E2873; color: white; margin-top: -20px;     padding: 50px 0px;">
				<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/vunwhi5i1zlmyotoybt5.png" />
				<p class="text-know-others">Know others who could benefit from this assessment?</p>
										...
										<div class="text"
											...
											<table class="hero-table desktop"
												...
												<tr>
													...
													<td>
														<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/fomsuqqjlhpw8uo2voc8.png">
													</td>
											...
											<table style="display: none" class="hero-table mobile">
												<tbody>
													<tr>
														<td>
															<h3 class="score-heading">Your score is</h3>
															<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208411/Glo-Raise/e8isqmrie7cctwludjmj.png">
															<p class="schore-text"
																style="    margin-left: 50px; font-size: 16px; line-height: 24px; color: black; padding:0px;">
																Scores range from Level 1 (lowest) to Level 5 (highest)
																with
  ...
  return `<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
	...
	<body width="100%"
		...
		<center style="width: 100%; background-color: #f1f1f1;">
										...
										<div class="text"
											...
											<table class="hero-table desktop"
												...
												<tr>
													...
													<td>
														<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/ezdexr7nlchjwkymnyxy.png">
													</td>
											...
											<table style="display: none" class="hero-table mobile">
												<tbody>
													<tr>
														<td>
															<h3 class="score-heading">Your score is</h3>
															<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/gpxwfn49ksdxmi3lzqo3.png">
															<p class="schore-text"
																style="    margin-left: 50px; font-size: 16px; line-height: 24px; color: black; padding:0px;">
																Scores range from Level 1 (lowest) to Level 5 (highest)
																with
			...
			<img class="desktop" style="position: absolute; z-index: -1;	margin-top: -379px;	left: -30px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/cdh7sbancvufwy7vgedv.png" />
			<img class="mobile" style="position: absolute; z-index: -1;	width: 100%;margin-top: -100px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/tdhhye4xgt1uvgrmdum6.png" />
			</td>
			</tr><!-- end tr -->
			</table>
			</div>
  ...
  return `<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
	...
	<body width="100%"
		...
		<center style="width: 100%; background-color: #f1f1f1;">
										...
										<div class="text"
											...
											<table class="hero-table desktop"
												...
												<tr>
													...
													<td>
														<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/og4fdj00yekttv3gd5y3.png">
													</td>
											...
											<table style="display: none" class="hero-table mobile">
												<tbody>
													<tr>
														<td>
															<h3 class="score-heading">Your score is</h3>
															<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/t9cdbvdu0eyrkgazx1yq.png">
															<p class="schore-text"
																style="    margin-left: 50px; font-size: 16px; line-height: 24px; color: black; padding:0px;">
																Scores range from Level 1 (lowest) to Level 5 (highest)
																with
			...
			<img class="desktop" style="position: absolute; z-index: -1;	margin-top: -379px;	left: -30px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/iuhpwnoca9ivcmjvdavx.png" />
			<img class="mobile" style="position: absolute; z-index: -1;	width: 100%;margin-top: -100px;"
				src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208412/Glo-Raise/txuygp0h8rml9yatslva.png" />
			</td>
			</tr><!-- end tr -->
			</table>
			</div>
  ...
  return `<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
	...
	<body width="100%"
		...
		<center style="width: 100%; background-color: #f1f1f1;">
			...
			<div>
				<img class="desktop" style="width: 100%;"  src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/tisqmm6mt9nisbxwtnuv.png"/>
				<img class="mobile" style="width: 100%;" src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208413/Glo-Raise/snwl3dltsk1fnrsqnixq.png"/>
			</div>
			<div style="background-color: #2E2873; color: white; margin-top: -20px;     padding: 50px 0px;">
				<img src="https://res.cloudinary.com/diiohnshc/image/upload/v1705208480/Glo-Raise/vunwhi5i1zlmyotoybt5.png" />
				<p class="text-know-others">Know others who could benefit from this assessment?</p>
