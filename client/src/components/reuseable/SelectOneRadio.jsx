...
export default function SelectOneRadio({
  ...
  return (
    <div className="w-[min(644px,100%)] mx-auto pt-[56px] pb-[72px] md:pt-[80px] md:pb-[100px] lg:py-[90px] lg:pb-[132px] px-4 md:px-[60px] lg:px-[132px]">
      <div className="border-2 border-Dark rounded-[20px] py-[56px] px-2 md:px-[6px] lg:px-[12px] relative grid gap-12">
        ...
        <div className="grid gap-3">
          <p className="text-[38px] font-semibold text-Dark text-center">
            {assessment.qstn}
          </p>
