  ...
  return (
    <section className="bg-Nature  overflow-x-hidden pt-[56px] pb-[72px] md:pt-[80px] md:pb-[100px] lg:py-[90px] lg:pb-[132px]">
      <div className="w-[min(80rem,100%)] mx-auto">
        <div className="flex">
          {testimonies.map((testimony, index) => (
            <div
              ...
              className="w-[min(80rem,100%)] px-4 md:px-[60px] lg:px-[132px] grid md:flex gap-4 shrink-0 [transition:0.5s_ease]"
            >
              <svg
        ...
        <div className="px-4 md:px-[60px] lg:px-[132px] mt-4 grid md:flex gap-4">
