...
const initialState = {
  ...
  fundersAssessmentFile: [
    ...
    },
    {
      add_more: false,
      number: "06",
      qstn: "We're open to considering businesses that have the potential to reach these revenues in the next three years",
      options: [
        "Totally like us",
        "Mostly like us",
        "Somewhat like us",
    ...
    },
    {
      add_more: true,
      number: "08",
      qstn: "We're interested in businesses utilizing this sales approach",
      options: [
        "Totally like us",
        "Mostly like us",
        "Somewhat like us",
    ...
    },
    {
      add_more: false,
      number: "09",
      qstn: "We're most interested in businesses that uniquely compete on these dimensions",
      options: [
        "Price",
        "Service",
        "Reliability",
    ...
    },
    {
      add_more: false,
      number: "11",
      qstn: "We're most interested in businesses that require this level of change to existing customer behavior",
      options: [
